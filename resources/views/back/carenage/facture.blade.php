                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span class="text-600 text-110 text-blue align-middle">$nom_client</span>
                        </div>
                        <div>
                            <span class="text-sm text-grey-m2 align-middle">Nom bateau:</span>
                            <span class="text-600 text-110 text-blue align-middle">$nom_bateau</span>
                        </div>
                        <div>
                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-9 col-sm-5">Droit de carenage</div>
                            <div class="d-none d-sm-block col-2">2202</div>
